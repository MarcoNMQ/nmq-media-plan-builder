...
import { BENCHMARK_SOURCES, buildPlanSummary } from '@/lib/aiContext';
import { marketBudget } from '@/lib/budgets';
import { MARKET_LABELS } from '@/lib/constants';
import type { AiChatKind, PlanConfig, Scenario } from '@/lib/types';
