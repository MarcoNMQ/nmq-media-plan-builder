...
import { buildTable, generatePeriods } from '@/lib/calc';
import { channelBudget } from '@/lib/budgets';
import { useMediaPlanStore } from '@/lib/store';
import { BenchmarkEditor } from '@/components/BenchmarkEditor';
import { PeriodTable } from '@/components/PeriodTable';
import { Funnel } from '@/components/Funnel';
import { Select } from '@/components/Field';
import type { GoalConfig, LinkedInFormat, MarketConfig, Scenario } from '@/lib/types';
